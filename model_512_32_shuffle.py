...
model_name = str(filters) + '_filters_batch_size_' + str(batch_size) + '_test_' + info + '_' + str(test_nr)

# folders
TRAIN_PATH = 'train_data_easy_840'
...
callbacks = [
        ...
        tf.keras.callbacks.TensorBoard(log_dir='logs3', histogram_freq=1, embeddings_freq=1,)]
