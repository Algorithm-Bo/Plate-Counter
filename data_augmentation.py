...
# image_folder = 'data/images_validation_10'
# mask_folder = 'data/binary_masks_validation_10'

# output folder for augmented images and masks
output_foldername = 'data/augmented_images_train'
...
aug1 = iaa.SomeOf(3, [ # choose 3 randomly
    iaa.GaussianBlur((0, 3.0)), # Blur
    iaa.Fliplr(1.0), # flip horizontally
    iaa.Flipud(1.0), # flip vertically
    iaa.Affine(rotate=(-45, 45)), # rotate
    iaa.Affine(translate_px={"x": (-10, 10), "y": (-10, 10)}), # translate
    iaa.Affine(shear=(-16, 16)), # shear
    iaa.PiecewiseAffine(scale=(0.01, 0.05)),
    iaa.ScaleX((0.8, 1.0)), # scale x axis
    iaa.ScaleY((0.8, 1.0)),
